...
Если Вас устраивают приведённые выше условия прохождения опроса, нажмите \"Продолжить'\", и мы перейдём непосредственно к опросу. В противном случае нажмите \"Отказаться\", и мы Вас больше не потревожим :)"
        ],
        'bye' => [
...
Нажмите \"Продолжить\", чтобы перейти к опросу, или \"Отказаться\", чтобы не проходить его."
        ],
        'already_passed' => [
        ...
        'confirm_sex' => [
            ...
            'Вы указали в своём аккаунте ВКонтакте, что Ваш пол -- %s. Всё верно?'
        ],
        'ask_sex' => [
            'Уточните, пожалуйста, Ваш пол. Отправьте одно слово, "мужской" или "женский".'
        ],
        'confirm_age' => [
            'Из Вашего аккаунта ВКонтакте мы узнали, что Вам %s. Всё верно?',
            'В Вашем аккаунте ВКонтакте указано, что Вам %s. Это верно?'
        ],
        'ask_age' => [
        ...
        'ask_diagnosis' => [
            'Есть ли у Вас какие-либо диагнозы, который Вам поставил врач? Если есть, перечислите их через запятую, если нет, то просто напишите "Нет".',
            'Ставил ли Вам врач какие-либо диагнозы? Если да, укажите их через запятую, если нет, то просто напишите "Нет".',
        ],
        'ask_adr_drug' => [
            'Какой препарат, на Ваш взгляд, вызвал побочную реакцию?'
        ],
        'ask_other_drugs' => [
            'Принимали ли Вы другие препараты параллельно c этим?',
            'Принимали ли Вы другие препараты параллельно с тем, который вызвал нежелательную реакцию?'
        ],
        'ask_adr' => [
            'Теперь о главном: расскажите непосредственно про побочные эффекты, которые у Вас проявились. Чем подробнее Вы это сделаете, тем лучше.',
